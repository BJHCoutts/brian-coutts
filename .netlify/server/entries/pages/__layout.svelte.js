...
const css$4 = {
  code: "footer.svelte-1s7vqxx{background-color:var(--bg)}h2.svelte-1s7vqxx{color:var(--fg)}",
  map: null
};
const Footer = (0, import_index_544abe4e.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<footer class="${"main-grid-layout padding svelte-1s7vqxx"}"><div class="${"main-grid-center"}"><h2 class="${"svelte-1s7vqxx"}">Footer: Use Cube Pixel pattern transition</h2></div></footer>`;
});
...
const css$3 = {
  code: "header.svelte-1s2e9e1{position:sticky;top:0;left:0;right:0;z-index:3;overflow:visible;padding:1em 0}.back.svelte-1s2e9e1{transform:rotateY(180deg)}.center-container.svelte-1s2e9e1{display:flex;justify-content:space-between;align-items:center}.email-container.svelte-1s2e9e1{border-radius:5px;border:2px solid var(--accent);width:fit-content;display:grid;place-items:center;padding:.2em .4em;background-color:var(--bg);cursor:pointer;color:var(--fg);box-shadow:var(--box-shadow)}.front.svelte-1s2e9e1{transform:rotateY(0deg)}.icon-container.svelte-1s2e9e1{border-radius:50%;border:2px solid var(--accent);width:fit-content;aspect-ratio:1 / 1;display:grid;place-items:center;padding:.2em;background-color:var(--bg);cursor:pointer;position:absolute;transform-origin:50% 50% 0px;transition:transform .4s ease-in;backface-visibility:hidden;box-shadow:var(--box-shadow)}.place-holder.svelte-1s2e9e1{height:34.39px;width:34.39px;display:inline-block}",
  map: null
};
const Header = (0, import_index_544abe4e.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="${"main-grid-layout glassmorph shadow-down svelte-1s2e9e1"}"><div class="${"main-grid-layout-center center-container svelte-1s2e9e1"}"><div class="${(0, import_index_544abe4e.e)((0, import_index_544abe4e.d)(`icon-container ${$menuIsOpen ? "back" : "front"}`)) + " svelte-1s2e9e1"}">${(0, import_index_544abe4e.v)(MenuIcon, "MenuIcon").$$render($$result, {}, {}, {})}</div>
		
		<div class="${(0, import_index_544abe4e.e)((0, import_index_544abe4e.d)(`icon-container ${$menuIsOpen ? "front" : "back"}`)) + " svelte-1s2e9e1"}">${(0, import_index_544abe4e.v)(ClearIcon, "ClearIcon").$$render($$result, {}, {}, {})}</div>

		<div class="${"place-holder svelte-1s2e9e1"}"></div>

		<a href="${"mailto: bjhcoutts@gmail.com"}" target="${"_blank"}" class="${"email-container svelte-1s2e9e1"}">Contact Me: bjhcoutts@gmail.com</a></div></header>`;
});
